//! This example shows the usage of a Collection of Images tileset
//! as object tiles. It also shows the usage of a terrain layer.
...
fn startup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    commands.spawn((
        TiledMap(asset_server.load("image_collection/map.tmx")),
